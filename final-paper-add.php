        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="basic-form">
                    <form action="final-paper-insert.php " method="Post" id="cloInsert" class="cloInsert">
                        <div class="form-row">
               ...
               <div class="form-group col-md-4">
                ...
                <button style="background-color: #00ffff; color: black; " class="btn"><a href="final-paper-add">view</a></button>
