                ...
                <div class="basic-form">
                    <form action="Assignments-insert.php " method="Post" id="cloInsert" class="cloInsert">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold text-dark">Assignment</label>

                                <select name="assignment" id="cloInsert8" class="form-control">
                                    <option value="" selected>Choose Assignment No</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                        ...
                        <a href="Assignment.view.php" class="btn"
                            style="background-color: #00ffff; color: black;">View</a>
