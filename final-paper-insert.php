...
if (isset($_POST["btn"])) {
    ...
    $query = "INSERT INTO `final_paper`(`teacher_name`, `Department name`, `semester`, `session`, `course_name`, `marks`) VALUES ('{ $techername2}','{ $Departmentname2}','{ $semester3}','{$session3}','{  $coursename3}','{  $marks1}')";
