        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="height: 50px; border-radius: 10px; padding-top: 12px; padding-left: 10px; background-color : #006400; color: white;">
                    Hod View ASSIGNMENT& Quizz </h4>
                <div class="basic-form">
                    <form action="Teacher-assignment-quiz-uplodedinsert.php" method="Post" id="cloInsert" class="cloInsert">
                        <div class="form-row">
               ...
               <div class="form-group col-md-5">
                                ...
                                <select name="subjectname" id="cloInsert5" class="form-control">
                      ...
                      <div class="form-group col-md-5">
                                ...
                                <select name="assignment1" id="cloInsert6" class="form-control">
                                ...
                                <select name="assignment2" id="cloInsert6" class="form-control">
                                    <option value="" selected>Assignment NO</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select name="assignment3" id="cloInsert6" class="form-control">
                                    <option value="" selected>Assignment NO</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select name="assignment4" id="cloInsert6" class="form-control">
                                    <option value="" selected>Assignment NO</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select name="quiz12" id="cloInsert6" class="form-control">
                                ...
                                <select name="quiz13" id="cloInsert6" class="form-control">
                                    <option value="" selected>Quiz NO</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select name="quiz14" id="cloInsert6" class="form-control">
                                    <option value="" selected>Quiz NO</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select name="quiz15" id="cloInsert6" class="form-control">
                                    <option value="" selected>Quiz NO</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                ...
                <button style="background-color: #00ffff; color: black; " class="btn"><a href="Teacher-assignment-quiz-uplodedview.php">view</a></button>
